...
public class KatolikActivity extends AppCompatActivity {
    ...
    public static class PlaceholderFragment extends Fragment {
         ...
         * number.
         */
        public static KatolikActivity.PlaceholderFragment newInstance(int sectionNumber) {
            KatolikActivity.PlaceholderFragment fragment = new KatolikActivity.PlaceholderFragment();
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            if (getArguments().getInt(ARG_SECTION_NUMBER) == 1) {
                View rootView = inflater.inflate(R.layout.activity_today_katolik, container, false);
                return rootView;
            } else if (getArguments().getInt(ARG_SECTION_NUMBER) == 2) {
                View rootView = inflater.inflate(R.layout.fragment_katolik_doa, container, false);
                return rootView;
            } else {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return KatolikActivity.PlaceholderFragment.newInstance(position + 1);
        }
