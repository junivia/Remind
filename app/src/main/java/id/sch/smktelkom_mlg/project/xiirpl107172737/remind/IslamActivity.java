...
public class IslamActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_islam_layout, menu);
        return true;
    }
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            switch (position) {
                case 0:
                    reminder_islam tab1 = new reminder_islam();
                    return tab1;
                case 1:
                    today_islam tab2 = new today_islam();
                    return tab2;
                case 2:
                    doa_islam tab3 = new doa_islam();
                    return tab3;
                default:
                    return null;
            }
